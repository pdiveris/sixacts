    ...
    <div class="columns">
        <div class="column is-12">
            <div class="box content" >
                <h1 class="is-2">The Project</h1>
                <h2 class="is-3">The Launch</h2>
                <p>
                    The Six Acts online poll will <i>go live to the public at 4pm on the 17th August 2019.</i>
                </p>
                <p>
                    To mark the occasion and to commemorate the 200th anniversary of the Peterloo Massacre, the
                    Peterloo Memorial Campaign and the Six Acts team will be throwing a public 'Illegal PICNIC'
                    launch party on the site of the massacre – <strong>Manchester Central forecourt, Windmill Street,
                    M2 3GX on the 17th August, from 3 – 5:30pm.</strong>
                </p>
                <p>
                ...
                <p>
                    ...
                    treat their votes sparingly, with respect, and only vote for proposals that you believe are genuine,
                ...
                <p>
                    ...
                    politicians to cite, publicise and adopt these Six Acts as a basis for policy-making or further
                    research.
                </p>
                <p>
                    The Six Acts document will also serve as a position statement or manifesto that groups and
                    individuals can sign up to and endorse, as well as being adapted into a petition to be presented to
                    the Petitions Committee for debate in Parliament.
                </p>
                <p>
                    All of the proposals submitted to the poll will be preserved on the site in an archive for future
                    debate and reference.
                </p>
                <p>
                    <i>
                        Rather than a fixed, rigid manifesto, we want the Six Acts to be a working document which can
                        be updated or reviewed annually and revisited on an ongoing basis... particularly on the 16th
                        of August each year
                    </i>
                </p>
            </div>
